            ...
            <div class="col-md-10">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputJudul" name="inpJudul"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputLinkData" name="inpLinkData"
                            placeholder="Masukkan link data">
                    </div>
                    <button type="submit" class="btn tombol" name="upload_dataset" value="Save"
                        style="margin-bottom:3rem; background-color: red; color:white;">Submit</button><br>
                </form>
            </div>
        </div>
